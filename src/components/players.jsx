      ...
      <div className="card has-table has-mobile-sort-spaced">
        <header className="card-header">
          ...
          <p className="card-header-title">
            ...
            <span className="hidden-mobile twenty-two">PLAYERS </span>
            {!popup ? (
              <div className="hidden-mobile twenty-two">
                ...
                {transactions.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td>
                      ...
                      >
                        <div className="addressText addressTextOldPhones">
                          {item.address}
                          {item.address ===
