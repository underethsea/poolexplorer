...
var textArray = [
    'Searching for prizes. Lots of prizes...',
    'How many prizes can there be?!? Still looking... ',
...
function UsdcWinners() {
  ...
  setDepositors(transactions.length);
  let totals = 0;
  let balance = 0;
                ...
                {transactions.map((item) => (
                  <tr>
                    ...
                    <td>
                      {item.chain == "1" ? (
                        <span>
                          <img src="./images/ethereum.png" className="emoji" />{" "}
                          &nbsp;&nbsp;
                          <a
                            href={
                        ...
                        <span>
                          <img src="./images/polygon.png" className="emoji" />
                          &nbsp;&nbsp;
                          <a
                            href={
